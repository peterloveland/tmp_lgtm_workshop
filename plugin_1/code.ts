        ...
        messages: [
          {
            ...
            content: `You are a world class assistant to a user who needs you to help them. The user will give you a certain prompt and you will do as they say.
              ...
              You will respond with an object that matches this schema: { result: { title: string, description: string, author: string } }
              Author should be a quirky GitHub handle.  
            `,
          },
...
const do_something_with_response = (data: any) => {
  ...
  const titleNodes = getSpecificLayersFromSelection(nodesInSelection, "__title") as TextNode[];
  const descriptionNodes = getSpecificLayersFromSelection(nodesInSelection, "__description" ) as TextNode[];
  const authorNodes = getSpecificLayersFromSelection( nodesInSelection, "__author" ) as TextNode[];
...
// const OPENAI_API_KEY = "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";
